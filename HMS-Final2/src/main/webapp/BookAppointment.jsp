...
<div>
  <form action="addAppointment">
    <input type="text" name="patientId" placeholder="Enter your patient Id" value="${patient.iD}">
    <label for="doctorId">Doctor Id</label>
<select id="doctorId" name="doctorId" required>
			<c:forEach var="listValue" items="${doctorList}">
				<option value="${listValue.doctorId}">${listValue.doctorId}</option>
			</c:forEach>
		</select>
	<label for="applicationDate">Appointment Date</label>
	<input type="date" id="applicationDate" name="applicationDate" min="${min}" max="${max}" required><br><br>
